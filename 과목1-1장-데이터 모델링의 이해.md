...
## 7. ERD에 대한 설명
    - 주문은 반드시 고객이 있어야 한다.
## 8. ERD에 대한 설명
    - 1976년 피터첸에 의해 Entity-Relationship-Model 이라는 표기법이 만들어졌다.
    - 엔터티 도출 -> 엔터티 배치 -> 관계 설정 -> 관계명 기술의 흐름으로 작업을 진행한다
    - 관계의 명칭은 관계 표현에서 매우 중요한 부분에 해당한다.
    - 가장 중요한 엔터티는 왼쪽 상단에 배치하는 것이 원칙이다.
## 9. 시나리오에서 적절한 엔터티
    - 환자
## 10. 엔터티의 특징
...
## 12. 발생 시점에 따라 구분할 수 있는 엔터티의 유형
    - 엔터티는 발생 시점에 따라 기본, 중심, 행위 엔터티로 구분할 수 있다.
## 13. 엔터티에 이름 부여하는 방법
    - 약어 사용 X
...
---
---
## 16. 정규화 작업으로 가장 적절한 것은?
    - 주 식별자가 2개 이상일 때 종송적인 컬럼이 구분 되는 경우 -> 2차 정규화
## 17. 속성의 특성
...
## 20. 데이터 모델링의 관계에 대한 설명
    ...
    - UML에는 연관,의존 관계가 있고 실선과 점선의 표기법으로 다르게 표현이 된다.
    - 연관관계는 존재적관계, 의존관계는 행위적 관계에 해당한다.
...
## 24. [엔터티 사이에 정의한 관계에 대해 확인해야 할 사항 : 25번 참고](#25-엔터티-간-관계-도출-시-확인해야-할-사항)
